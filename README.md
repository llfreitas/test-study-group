...
Repositório do grupo de estudos sobre Teste de Software do [Training Center](https://training-center.github.io).
...
Este grupo se destina ao estudo de Teste de Software.
...
Basta responder [este formulário]() para sabermos seu nível de conhecimento, entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#Teste de Software-studies**.
...
Caso você precise entrar em contato com as pessoas responsáveis por este grupo de estudos, pode chamar por `@luana` no Slack do Training Center.
